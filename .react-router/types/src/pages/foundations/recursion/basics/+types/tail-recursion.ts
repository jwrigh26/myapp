...
type Module = typeof import("../tail-recursion")

export type Info = {
  parents: [Parent0, Parent1],
  id: "pages/foundations/recursion/basics/tail-recursion"
  file: "pages/foundations/recursion/basics/tail-recursion.tsx"
