...
type Module = typeof import("../string-matching")

export type Info = {
  parents: [Parent0, Parent1],
  id: "pages/foundations/strings/advanced/string-matching"
  file: "pages/foundations/strings/advanced/string-matching.tsx"
