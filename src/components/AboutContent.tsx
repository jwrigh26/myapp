...
const AdaptiveGrid = styled(Box, {
  ...
  // Smart column logic: wide images (16:9, etc.) get 1 column, squarish get 2
  gridTemplateColumns: aspectRatio > 1.5 ? '1fr' : '1fr 1fr',
...
export default function AboutContent() {
  ...
  // Sample comic frame data - replace with your actual image
  ...
  return (
    <AdaptiveGrid aspectRatio={comicAspectRatio}>
      {/* Comic frame section */}
      <ComicFrame
