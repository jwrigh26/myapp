...
import { ComparisonSection, TopicBlock } from '@/components/blog';
  ...
  head: () => ({
    ...
    meta: generateBlogPostMeta({
      ...
      description:
        'Explore the pros and cons of Module Federation, Single-Spa, and iframe-based micro-frontends, and why we chose our approach.',
      imageKey: '20250601-image-slide10',
      route: '/blog/frontend-design/microfrontends-part2',
      publishedDate: '2025-04-21',
    }),
  }),
});
  ...
  return (
    <BlogLayout>
      <CallToAction
        ...
        subtitle="Comparing Modern Alternatives"
        ...
        date="2025-04-21"
      />
      <TitleBlock>Decision Making</TitleBlock>
      <IntroBlock>
      ...
      <ProseBlock>
        ...
        quickly. Because of the complexity they offer classes and tutorias to
        help with integrating it properly.
      </ProseBlock>
      ...
      <BlogPostNavigator
        prev={{
          ...
          route: '/blog/frontend-design/microfrontends-part1',
        ...
        next={{
          ...
          route: '/blog/frontend-design/microfrontends-part3',
